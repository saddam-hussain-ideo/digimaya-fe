! function(e) {
    if (!e.hasInitialised) {
        ...
        e.customStyles = {}, e.Popup = function() {
            ...
            //         document.getElementById("allow").innerHTML= "Permitir Cookies";
            //         document.getElementById("cookieconsent:desc").innerHTML= "Este sitio web utiliza Cookies para que tengas la mejor experiencia al navegar.";
            //         document.getElementById("linking").innerHTML="Ver mas detalles";

            //     }, false);

            //     english.addEventListener('click', function () {
            //         langue(english, spanish);
            //         document.getElementById("allow").innerHTML= "Allow cookies";
            //         document.getElementById("cookieconsent:desc").innerHTML= "This website uses cookies to ensure you get the best experience on our website.";
            //         document.getElementById("linking").innerHTML= "Read More";

            //     }, false);
            //     // var elementLang = document.getElementById("fr");
            //     // var elementLangEn = document.getElementById("en");
            //     // if(elementLang=="fr"){
            //     //     document.getElementById("allow").innerHTML= "Permitir Cookies";
            //     // }
            //     // else if(elementLangEn=="en"){
            //     //     document.getElementById("allow").innerHTML= "Allow cookies";
            //     // }
            // }, 2000);
            ...
            var y = {
                ...
                elements: {
                    ...
                    // link: '<span id="cc-link"><a aria-label="learn more about cookies" role=button tabindex="0" class="cc-link" href="{{href}}" rel="noopener noreferrer nofollow" target="{{target}}">{{link}}</a></span>',
